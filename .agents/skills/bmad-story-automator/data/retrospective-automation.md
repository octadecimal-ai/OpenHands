...
4. **LLM Only**: Retrospectives DO NOT support Codex - always use LLM agent
...
Codex is **not compatible** with these requirements. Always spawn retrospective sessions with `--agent "llm"`.
