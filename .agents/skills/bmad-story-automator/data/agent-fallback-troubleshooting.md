...
### Issue: Session spawns LLM instead of Codex

**Symptoms:**
- Output shows LLM-specific messages (e.g., "You've used 84% of your weekly limit")
- Expected Codex but got LLM
...
**Cause:** Codex uses natural language prompts and may not follow structured workflow instructions as reliably as LLM.

**Mitigation strategies:**
1. **Use LLM for code-review by default** - More reliable at following multi-step workflows
...
agentConfig:
  ...
  perTask:
    ...
    dev:
      primary: "codex"
    # code-review: LLM recommended - more reliable at following workflow
    review:
      primary: "llm"
      fallback: false
```
...
4. **Codex sessions consistently incomplete** - Switch to LLM for that workflow
