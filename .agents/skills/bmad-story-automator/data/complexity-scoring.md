...
|---|---|---|---|
| ≤ 3 | **Low** | High success probability | LLM handles well autonomously |
| 4–7 | **Medium** | Normal execution, moderate risk | Codex primary with LLM fallback |
| ≥ 8 | **High** | Consider longer timeouts, may need intervention | Codex primary with LLM fallback, monitor closely |
