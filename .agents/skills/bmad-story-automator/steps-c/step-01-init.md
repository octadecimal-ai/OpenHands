...
I've added the story-automator Stop hook to .llm/settings.json.
This prevents the orchestrator from randomly stopping mid-workflow.

⚠️ **Please restart this LLM session** for the hook to take effect.
