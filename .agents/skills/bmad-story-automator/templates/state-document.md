...
# Configuration
aiCommand: "llm --dangerously-skip-permissions"  # Deprecated: use agentConfig
overrides:
  skipAutomate: false
  maxParallel: 1
...
agentConfig:
  defaultPrimary: "llm"    # Default agent: llm | codex
  defaultFallback: "codex"    # Default fallback: llm | codex | false (disabled)
