...
- **Organic/reactive:** `Trigger when code imports llm-provider SDK, or user asks to use LLM API.` — For lightweight skills that should activate on contextual signals, not explicit requests.
