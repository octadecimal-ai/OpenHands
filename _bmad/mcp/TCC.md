...
### Krok 2: Znajdź Cursor w Automation
```
Privacy & Security → Automation → Cursor
```
...
W razie problemów:
1. Sprawdź logi: `~/Library/Logs/Cursor/`
