...
**Rationale:** Obecny OpenHands rejestruje tylko pytania i decyzje użytkownika. Brakuje śledzenia sesji agentskich (np. OpenHands, Claude Code), powiązania z systemem zadań (Reminders) oraz integracji z bazą wiedzy (`knowledge-team.md`). Te elementy są potrzebne do pełnej rejestracji pracy zespołu.
