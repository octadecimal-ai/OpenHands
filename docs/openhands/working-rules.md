...
Istniejące zespoły produkcyjne automation assistant opisane w `docs/current-infrastructure.md` są nietykalne, dopóki osobna decyzja nie dopuści migracji, eksperymentu albo audytu.
...
Sesje z agentami (OpenHands, automation assistant, inne) są rejestrowane w `docs/openhands/sessions/`. Każda sesja otrzymuje własny plik z:
- Datą i czasem sesji
